...
import land.land.config.jwt.JwtFactory;
import land.land.config.jwt.JwtProperties;
import land.land.domain.RefreshToken;
import land.land.domain.User;
import land.land.dto.CreateAccessTokenRequest;
import land.land.repository.RefreshTokenRepository;
import land.land.repository.UserRepository;
...
class TokenApiControllerTest {
    ...
    public void mockMvcSetUp() {
        ...
        userRepository.deleteAll(); // 모든 데이터 초기화
